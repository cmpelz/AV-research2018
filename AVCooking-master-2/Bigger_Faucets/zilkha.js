...
function ZilkhaKitchen() {
    this.sim_appliances = [new ZilkhaAppliance("stove", "#cc0000"), new ZilkhaAppliance("fridge", "#70db70"), new ZilkhaAppliance("rangehood", "#ffcc00"), new ZilkhaAppliance("microwave", "#cc99ff"), new ZilkhaAppliance("oven", "#4dc3ff")],
