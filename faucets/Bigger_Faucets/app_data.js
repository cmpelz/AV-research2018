var data = {}; //data structure storing appliance powers 
var dataUpdateInterval = 10000;
var applianceDataFeed = 'ApplianceData3.csv'; //file to store appliance power values in
